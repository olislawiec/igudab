...
class Server
{
	...
	{// watki do servera
		...
		{
			try{
				while(true) // zamienic na do{}while(Connection_is_UP);
				{
					...
					{	if(true){
						...
						String msg2="";
									...
									for(iCount=0;iCount<LoginNames.size();iCount++)
									{
										...
										{    
											...
											if(msgFromClient.equals("007")){ System.out.println("Przyjalem!! @"); }
						...
						else
						{
							...
							if(iCount==LoginNames.size())
							{
								...
								System.out.println("4Zakonczono dzialanie.</"+Sendto+">");
							}
							else
							{
			...
			}catch(Exception e){System.out.println("Zglaszam blad i zamykam polaczenia.");
			socket.close();
			serverSocket.close();
			return;}
		}
