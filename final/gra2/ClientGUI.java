...
class ClientGUI extends Frame implements Runnable {
     ...
     */
    ClientGUI(String LoginName, String adres, String port, String players) throws Exception {
        super(LoginName);
        try {
        ...
        if (e.arg.equals("Send")) {
            try {
                ...
                if (komenda.equals("ADRES")) {
                    ...
                    if(Integer.parseInt(playerZ)>6 || Integer.parseInt(playerZ)<1)
                    {
                    	JOptionPane.showInputDialog("Przykro mi nie mozna uruchomic takiej rozgrywki!");
                    	System.exit(-1);
                    }
                    String adresP;
                    ...
                    try {
                        ClientGUI Client2 = new ClientGUI("ReMake", adresP, portP, playerZ);
                        Client2.setup();
                    } catch (Exception ex) {
